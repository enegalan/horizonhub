@php
    $exceptionStreamSig = \count($exception) > 0
        ? \hash('sha256', \json_encode(\array_values($exception), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES))
        : \hash('sha256', '');
@endphp
<div data-horizon-stream-sig="{{ $exceptionStreamSig }}">
