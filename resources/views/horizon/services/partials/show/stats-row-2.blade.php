...
<x-stat-card label="Max wait time" tone="sky" :value="$maxWaitTimeSeconds !== null ? (\App\Services\Jobs\JobRuntimeHelperService::getFormattedRuntime((float) $maxWaitTimeSeconds) ?? '–') : '–'" />
