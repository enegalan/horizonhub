<div class="flex shrink-0 items-center gap-1.5"
    ...
    >
        <span class="relative inline-flex size-5 items-center justify-center">
            <x-icons.sun class="absolute size-5 transition-opacity" x-show="themePreference === 'light'" x-cloak />
            <x-icons.moon class="absolute size-5 transition-opacity" x-show="themePreference === 'dark'" x-cloak />
            <x-icons.computer-desktop class="absolute size-5 transition-opacity" x-show="themePreference === 'system'" x-cloak />
        </span>
    </x-button>
</div>
